...
import com.tlaq.main_service.repositories.ValidateTokenRepository;
import com.tlaq.main_service.services.AuthService;
...
public class AuthServiceImpl implements AuthService {
    ...
    public SignedJWT verifyToken(String token, boolean isRefresh) throws JOSEException, ParseException {
        ...
        if (validateTokenRepository.existsById(signedJWT.getJWTClaimsSet().getJWTID()))
    ...
    public AuthenticationResponse refreshToken(RefreshRequest request) throws ParseException, JOSEException {
        ...
        validateTokenRepository.save(invalidatedToken);
