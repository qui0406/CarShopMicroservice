                    ...
                    {PAYMENT_METHODS.map(m => {
                      ...
                      return (
                        <button type="button" key={m.key}
                          ...
                          className={`flex items-center gap-3 px-4 py-3.5 border-2 rounded-xl transition-all text-left ${
                            isActive
                ...
                {["Tên Xe","Số Lượng","Đơn Giá","Tạm Tính","Thuế (10%)","Phương Thức"].map((label, i) => {
                      ...
                      return (
                        <div key={label} className="flex items-start justify-between">
                          ...
                          <span className={`text-xs text-right max-w-[130px] leading-tight ${
                            isBold ? "font-black text-gray-900" :
                  ...
                  <div className="px-5 pb-5">
                    ...
                    <button type="button" onClick={resetForm}
                      className="w-full mt-2 py-2.5 border border-gray-200 text-gray-600 text-xs font-black uppercase tracking-wider rounded-xl hover:bg-gray-50 transition-colors">
                      🔄 Làm Mới
                    </button>
